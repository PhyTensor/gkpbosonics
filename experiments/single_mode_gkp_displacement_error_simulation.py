...
def _(
    ...
    return circuit_noerror, gkp_state_noerror
...
def _(
    ...
    return circuit, gkp_state


@app.cell
def _(gkp_state_noerror):
...
@app.cell
def _(gkp_state, gkp_state_noerror):
...
@app.cell
def _(calculate_and_plot_marginals, gkp_state_noerror):
